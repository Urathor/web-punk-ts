...
export interface IScene {
  ...
  /** Called once when the scene is permanently removed from the stack. */
  onExit(): void

  /** Called when a scene is pushed on top of this one (this scene pauses). */
  onPause(): void

  /** Called when the scene above this one is popped, restoring this scene. */
  onResume(): void

  /** Fixed timestep update — ~16.67 ms per tick. Use for physics/game logic. */
